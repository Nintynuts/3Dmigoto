...
class HackerDevice : public IDirect3DUnknown
{
public:
    ...
    ID3D10ShaderResourceView* mZBufferResourceView;
    ID3D10Texture1D* mIniTexture;
    ID3D10ShaderResourceView* mIniResourceView;

    HackerDevice(ID3D10Device* pDevice);
    static HackerDevice* GetDirect3DDevice(ID3D10Device* pDevice);
    __forceinline ID3D10Device* GetD3D10Device() { return (ID3D10Device*) m_pUnk; }
